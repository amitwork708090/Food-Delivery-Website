  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      {data.shopOrders.map((shopOrder, index) => (
        ...
        >
          ...
          <div className="flex justify-between items-center border-t pt-2">
            ...
            <span className={shopOrder.status == "Delivered" ? "text-green-600" : "text-blue-600"}>
              {shopOrder.status}
            </span>
          </div>
        </div>
      ...
      <div className="flex justify-between items-center border-t pt-2">
        ...
        <button
          className="bg-[#ff4d2d] hover:bg-[#e64526] text-white px-4 py-2 rounded-lg text-sm font-medium"
